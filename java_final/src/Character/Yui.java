...
public class Yui {
	...
	public Yui(Collection coll) {
		...
		Image c = new Image(getClass().getResourceAsStream("char/normal_3.jpg"), 800, 450, false, true);
		ImageView c_iv = new ImageView(c);
		c_iv.setLayoutX(110);
		c_iv.setLayoutY(170);
		
		Label name = new Label("Name: Yuigahama Yui");
		name.setMinHeight(36);
		name.setId("Character_label");
		name.setLayoutX(183);
		name.setLayoutY(217);
		
		Label height = new Label("Height: unknown");
		height.setMinHeight(36);
		height.setId("Character_label");
		height.setLayoutX(183);
		height.setLayoutY(297);
		
		Label birthday = new Label("Birthday: 6/18");
