...
public class Manaca {
	...
	public Manaca(Collection coll) {
		...
		Image c = new Image(getClass().getResourceAsStream("char/rare_3.jpg"), 800, 450, false, true);
		ImageView c_iv = new ImageView(c);
		c_iv.setLayoutX(110);
		c_iv.setLayoutY(170);
		
		Label name = new Label("Name: Mukaido Manaka");
		name.setMinHeight(36);
		name.setId("Character_label");
		name.setLayoutX(183);
		name.setLayoutY(217);
		
		Label height = new Label("Height: 152 cm");
		...
		Label CV = new Label("CV: Hanazawa Kana");
		CV.setMinHeight(36);
		CV.setId("Character_label");
		CV.setLayoutX(183);
		CV.setLayoutY(457);
		
		Label type = new Label("Type: rare");
