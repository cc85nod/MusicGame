...
public class Shiro {
	...
	public Shiro(Collection coll) {
		...
		Image c = new Image(getClass().getResourceAsStream("char/rare_2.jpg"), 800, 450, false, true);
		ImageView c_iv = new ImageView(c);
		c_iv.setLayoutX(110);
		c_iv.setLayoutY(170);
		
		Label name = new Label("Name: Shiro");
		name.setMinHeight(36);
		name.setId("Character_label");
		name.setLayoutX(183);
		name.setLayoutY(217);
		
		Label height = new Label("Height: 135 cm");
		height.setMinHeight(36);
		height.setId("Character_label");
		height.setLayoutX(183);
		height.setLayoutY(297);
		
		Label birthday = new Label("Birthday: 2/16");
