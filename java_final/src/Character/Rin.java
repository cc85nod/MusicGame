...
public class Rin {
	...
	public Rin(Collection coll) {
		...
		Image c = new Image(getClass().getResourceAsStream("char/normal_4.jpg"), 800, 450, false, true);
		ImageView c_iv = new ImageView(c);
		c_iv.setLayoutX(110);
		c_iv.setLayoutY(170);
		
		Label name = new Label("Name: Shima Rin");
		name.setMinHeight(36);
		name.setId("Character_label");
		name.setLayoutX(608);
		name.setLayoutY(217);
		
		Label height = new Label("Height: 143 cm");
		height.setMinHeight(36);
		height.setId("Character_label");
		height.setLayoutX(608);
		height.setLayoutY(297);
		
		Label birthday = new Label("Birthday: 10/1");
