...
public class Mashiro {
	AnchorPane pane;
	public Mashiro(Collection coll) {
		pane = new AnchorPane();
		...
		Image c = new Image(getClass().getResourceAsStream("char/epic_1.jpg"), 800, 450, false, true);
		ImageView c_iv = new ImageView(c);
		c_iv.setLayoutX(110);
		c_iv.setLayoutY(170);
		
		Label name = new Label("Name: Shiina Mashiro");
		name.setMinHeight(36);
		name.setId("Character_label");
		name.setLayoutX(608);
		name.setLayoutY(217);
		
		Label height = new Label("Height: 162 cm");
