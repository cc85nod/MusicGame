...
public class Nayuta {
	...
	public Nayuta(Collection coll) {
		...
		Image c = new Image(getClass().getResourceAsStream("char/lend_2.png"), 800, 450, false, true);
		ImageView c_iv = new ImageView(c);
		c_iv.setLayoutX(110);
		c_iv.setLayoutY(170);
		
		Label name = new Label("Name: Kani Nayuta");
